...
set "status-right" "#[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey] #(/bin/bash $HOME/.tmux/kube-tmux/kube.tmux 250 cyan cyan)  #[fg=$onedark_green,bg=$onedark_visual_grey,bold]${time_format} #[fg=$onedark_yellow, bg=$onedark_visual_grey]#[fg=$onedark_red,bg=$onedark_yellow]"
...
set "window-status-format" "#[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_visual_grey,bg=$onedark_black] #I  #W #[fg=$onedark_black,bg=$onedark_black,nobold,nounderscore,noitalics]"
